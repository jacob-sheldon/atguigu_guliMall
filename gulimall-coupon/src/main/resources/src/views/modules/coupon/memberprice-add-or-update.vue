<template>
  <el-dialog
    ...
    <el-form-item label="会员价格" prop="memberPrice">
      <el-input v-model="dataForm.memberPrice" placeholder="会员价格"></el-input>
    </el-form-item>
    <el-form-item label="" prop="addOther">
      <el-input v-model="dataForm.addOther" placeholder=""></el-input>
    </el-form-item>
    </el-form>
