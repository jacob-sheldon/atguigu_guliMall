<template>
  <el-dialog
    ...
    <el-form-item label="????" prop="subcribeTime">
      <el-input v-model="dataForm.subcribeTime" placeholder="????"></el-input>
    </el-form-item>
    <el-form-item label="????" prop="sendTime">
      <el-input v-model="dataForm.sendTime" placeholder="????"></el-input>
    </el-form-item>
    <el-form-item label="????[0-??,1-??]" prop="noticeType">
      <el-input v-model="dataForm.noticeType" placeholder="????[0-??,1-??]"></el-input>
    </el-form-item>
    </el-form>
