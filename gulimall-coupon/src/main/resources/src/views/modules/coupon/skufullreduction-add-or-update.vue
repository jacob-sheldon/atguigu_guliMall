<template>
  <el-dialog
    ...
    <el-form-item label="全价" prop="fullPrice">
      <el-input v-model="dataForm.fullPrice" placeholder="全价"></el-input>
    </el-form-item>
    <el-form-item label="减少的价格" prop="reducePrice">
      <el-input v-model="dataForm.reducePrice" placeholder="减少的价格"></el-input>
    </el-form-item>
    <el-form-item label="其他" prop="addOther">
      <el-input v-model="dataForm.addOther" placeholder="其他"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          fullPrice: [
            { required: true, message: '全价不能为空', trigger: 'blur' }
          ],
          reducePrice: [
            { required: true, message: '减少的价格不能为空', trigger: 'blur' }
          ],
          addOther: [
