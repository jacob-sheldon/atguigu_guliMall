<template>
  <el-dialog
    ...
    <el-form-item label="?????[0->????;1->????;2->????;3->????]" prop="couponType">
      <el-input v-model="dataForm.couponType" placeholder="?????[0->????;1->????;2->????;3->????]"></el-input>
    </el-form-item>
    ...
    <el-form-item label="??????" prop="perLimit">
      <el-input v-model="dataForm.perLimit" placeholder="??????"></el-input>
    </el-form-item>
    ...
    <el-form-item label="?????????[0->????,??-????]" prop="memberLevel">
      <el-input v-model="dataForm.memberLevel" placeholder="?????????[0->????,??-????]"></el-input>
    </el-form-item>
    <el-form-item label="????[0-???,1-???]" prop="publish">
      <el-input v-model="dataForm.publish" placeholder="????[0-???,1-???]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          memberLevel: [
            { required: true, message: '?????????[0->????,??-????]不能为空', trigger: 'blur' }
          ],
          publish: [
