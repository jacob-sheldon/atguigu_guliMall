<template>
  <el-dialog
    ...
    <el-form-item label="等级名" prop="name">
      <el-input v-model="dataForm.name" placeholder="等级名"></el-input>
    </el-form-item>
    ...
    <el-form-item label="" prop="freeFreightPoint">
      <el-input v-model="dataForm.freeFreightPoint" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="commentGrowthPoint">
      <el-input v-model="dataForm.commentGrowthPoint" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="priviledgeFreeFreight">
      <el-input v-model="dataForm.priviledgeFreeFreight" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="priviledgeMemberPrice">
      <el-input v-model="dataForm.priviledgeMemberPrice" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="priviledgeBirthday">
      <el-input v-model="dataForm.priviledgeBirthday" placeholder=""></el-input>
    </el-form-item>
