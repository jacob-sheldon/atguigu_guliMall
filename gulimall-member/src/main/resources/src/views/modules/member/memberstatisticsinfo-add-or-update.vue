<template>
  <el-dialog
    ...
    <el-form-item label="退货订单数" prop="returnOrderCount">
      <el-input v-model="dataForm.returnOrderCount" placeholder="退货订单数"></el-input>
    </el-form-item>
    <el-form-item label="登录次数" prop="loginCount">
      <el-input v-model="dataForm.loginCount" placeholder="登录次数"></el-input>
    </el-form-item>
    <el-form-item label="关注数" prop="attendCount">
      <el-input v-model="dataForm.attendCount" placeholder="关注数"></el-input>
    </el-form-item>
    ...
    <el-form-item label="邀请好友数" prop="inviteFriendCount">
      <el-input v-model="dataForm.inviteFriendCount" placeholder="邀请好友数"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          returnOrderCount: [
            { required: true, message: '退货订单数不能为空', trigger: 'blur' }
          ],
          loginCount: [
          ...
          inviteFriendCount: [
            { required: true, message: '邀请好友数不能为空', trigger: 'blur' }
          ]
        }
      }
    },
