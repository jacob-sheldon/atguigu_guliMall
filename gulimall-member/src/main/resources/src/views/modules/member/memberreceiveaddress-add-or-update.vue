<template>
  <el-dialog
    ...
    <el-form-item label="省份/城市" prop="province">
      <el-input v-model="dataForm.province" placeholder="省份/城市"></el-input>
    </el-form-item>
    ...
    <el-form-item label="地区码" prop="areacode">
      <el-input v-model="dataForm.areacode" placeholder="地区码"></el-input>
    </el-form-item>
    <el-form-item label="默认状态" prop="defaultStatus">
      <el-input v-model="dataForm.defaultStatus" placeholder="默认状态"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          province: [
            { required: true, message: '省份/城市不能为空', trigger: 'blur' }
          ],
          city: [
