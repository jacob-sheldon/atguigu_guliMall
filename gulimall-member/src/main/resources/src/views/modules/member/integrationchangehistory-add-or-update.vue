<template>
  <el-dialog
    ...
    <el-form-item label="????" prop="changeCount">
      <el-input v-model="dataForm.changeCount" placeholder="????"></el-input>
    </el-form-item>
    <el-form-item label="??" prop="note">
      <el-input v-model="dataForm.note" placeholder="??"></el-input>
    </el-form-item>
    <el-form-item label="??[0->??;1->?????;2->??]" prop="sourceTyoe">
      <el-input v-model="dataForm.sourceTyoe" placeholder="??[0->??;1->?????;2->??]"></el-input>
    </el-form-item>
    </el-form>
