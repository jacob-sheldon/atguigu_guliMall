<template>
  <el-dialog
    ...
    <el-form-item label="???[??;??;?????]" prop="operateMan">
      <el-input v-model="dataForm.operateMan" placeholder="???[??;??;?????]"></el-input>
    </el-form-item>
    <el-form-item label="????" prop="createTime">
      <el-input v-model="dataForm.createTime" placeholder="????"></el-input>
    </el-form-item>
    <el-form-item label="?????0->???;1->???;2->???;3->???;4->???;5->?????" prop="orderStatus">
      <el-input v-model="dataForm.orderStatus" placeholder="?????0->???;1->???;2->???;3->???;4->???;5->?????"></el-input>
    </el-form-item>
