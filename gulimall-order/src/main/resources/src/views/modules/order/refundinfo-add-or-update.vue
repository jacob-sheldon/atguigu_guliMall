<template>
  <el-dialog
    ...
    <el-form-item label="?????" prop="orderReturnId">
      <el-input v-model="dataForm.orderReturnId" placeholder="?????"></el-input>
    </el-form-item>
    <el-form-item label="????" prop="refund">
      <el-input v-model="dataForm.refund" placeholder="????"></el-input>
    </el-form-item>
    <el-form-item label="???????" prop="refundSn">
      <el-input v-model="dataForm.refundSn" placeholder="???????"></el-input>
    </el-form-item>
    <el-form-item label="????" prop="refundStatus">
      <el-input v-model="dataForm.refundStatus" placeholder="????"></el-input>
    </el-form-item>
    <el-form-item label="????[1-???,2-??,3-??,4-??]" prop="refundChannel">
      <el-input v-model="dataForm.refundChannel" placeholder="????[1-???,2-??,3-??,4-??]"></el-input>
    </el-form-item>
