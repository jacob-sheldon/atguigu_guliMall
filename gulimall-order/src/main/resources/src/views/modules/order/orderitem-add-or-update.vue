<template>
  <el-dialog
    ...
    <el-form-item label="??" prop="spuBrand">
      <el-input v-model="dataForm.spuBrand" placeholder="??"></el-input>
    </el-form-item>
    <el-form-item label="????id" prop="categoryId">
      <el-input v-model="dataForm.categoryId" placeholder="????id"></el-input>
    </el-form-item>
    <el-form-item label="??sku??" prop="skuId">
      <el-input v-model="dataForm.skuId" placeholder="??sku??"></el-input>
    </el-form-item>
    <el-form-item label="??sku??" prop="skuName">
      <el-input v-model="dataForm.skuName" placeholder="??sku??"></el-input>
    </el-form-item>
    <el-form-item label="??sku??" prop="skuPic">
      <el-input v-model="dataForm.skuPic" placeholder="??sku??"></el-input>
    </el-form-item>
    <el-form-item label="??sku??" prop="skuPrice">
      <el-input v-model="dataForm.skuPrice" placeholder="??sku??"></el-input>
    </el-form-item>
    <el-form-item label="???????" prop="skuQuantity">
      <el-input v-model="dataForm.skuQuantity" placeholder="???????"></el-input>
    </el-form-item>
    ...
    <el-form-item label="?????????????" prop="realAmount">
      <el-input v-model="dataForm.realAmount" placeholder="?????????????"></el-input>
    </el-form-item>
    <el-form-item label="????" prop="giftIntegration">
      <el-input v-model="dataForm.giftIntegration" placeholder="????"></el-input>
    </el-form-item>
    <el-form-item label="?????" prop="giftGrowth">
      <el-input v-model="dataForm.giftGrowth" placeholder="?????"></el-input>
    </el-form-item>
    </el-form>
