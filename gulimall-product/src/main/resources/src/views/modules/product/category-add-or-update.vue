<template>
  <el-dialog
    ...
    <el-form-item label="父类id" prop="parentCid">
      <el-input v-model="dataForm.parentCid" placeholder="父类id"></el-input>
    </el-form-item>
    <el-form-item label="分类等级" prop="catLevel">
      <el-input v-model="dataForm.catLevel" placeholder="分类等级"></el-input>
    </el-form-item>
    <el-form-item label="是否展示[0-不展示,1-展示]" prop="showStatus">
      <el-input v-model="dataForm.showStatus" placeholder="是否展示[0-不展示,1-展示]"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          showStatus: [
            { required: true, message: '是否展示[0-不展示,1-展示]不能为空', trigger: 'blur' }
          ],
          sort: [
