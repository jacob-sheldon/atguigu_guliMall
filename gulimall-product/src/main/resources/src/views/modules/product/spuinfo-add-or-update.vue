<template>
  <el-dialog
    ...
    <el-form-item label="????" prop="spuDescription">
      <el-input v-model="dataForm.spuDescription" placeholder="????"></el-input>
    </el-form-item>
    ...
    <el-form-item label="??id" prop="brandId">
      <el-input v-model="dataForm.brandId" placeholder="??id"></el-input>
    </el-form-item>
    <el-form-item label="" prop="weight">
      <el-input v-model="dataForm.weight" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="????[0 - ??,1 - ??]" prop="publishStatus">
      <el-input v-model="dataForm.publishStatus" placeholder="????[0 - ??,1 - ??]"></el-input>
    </el-form-item>
