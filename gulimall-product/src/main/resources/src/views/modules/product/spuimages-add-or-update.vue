<template>
  <el-dialog
    ...
    <el-form-item label="???" prop="imgName">
      <el-input v-model="dataForm.imgName" placeholder="???"></el-input>
    </el-form-item>
    ...
    <el-form-item label="?????" prop="defaultImg">
      <el-input v-model="dataForm.defaultImg" placeholder="?????"></el-input>
    </el-form-item>
    </el-form>
