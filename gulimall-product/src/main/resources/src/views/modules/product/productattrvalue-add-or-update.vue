<template>
  <el-dialog
    ...
    <el-form-item label="??id" prop="spuId">
      <el-input v-model="dataForm.spuId" placeholder="??id"></el-input>
    </el-form-item>
    ...
    <el-form-item label="???" prop="attrValue">
      <el-input v-model="dataForm.attrValue" placeholder="???"></el-input>
    </el-form-item>
    <el-form-item label="??" prop="attrSort">
      <el-input v-model="dataForm.attrSort" placeholder="??"></el-input>
    </el-form-item>
    <el-form-item label="?????????????;0-? 1-??" prop="quickShow">
      <el-input v-model="dataForm.quickShow" placeholder="?????????????;0-? 1-??"></el-input>
    </el-form-item>
    </el-form>
