<template>
  <el-dialog
    ...
    <el-form-item label="??id" prop="commentId">
      <el-input v-model="dataForm.commentId" placeholder="??id"></el-input>
    </el-form-item>
    <el-form-item label="??id" prop="replyId">
      <el-input v-model="dataForm.replyId" placeholder="??id"></el-input>
    </el-form-item>
    </el-form>
