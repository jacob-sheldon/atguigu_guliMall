<template>
  <el-dialog
    ...
    <el-form-item label="??ip" prop="memberIp">
      <el-input v-model="dataForm.memberIp" placeholder="??ip"></el-input>
    </el-form-item>
    <el-form-item label="????" prop="createTime">
      <el-input v-model="dataForm.createTime" placeholder="????"></el-input>
    </el-form-item>
    <el-form-item label="????[0-???,1-??]" prop="showStatus">
    ...
    <el-form-item label="????/??[json??;[{type:????,url:????}]]" prop="resources">
      <el-input v-model="dataForm.resources" placeholder="????/??[json??;[{type:????,url:????}]]"></el-input>
    </el-form-item>
    ...
    <el-form-item label="????[0 - ????????,1 - ??????]" prop="commentType">
      <el-input v-model="dataForm.commentType" placeholder="????[0 - ????????,1 - ??????]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          resources: [
            { required: true, message: '????/??[json??;[{type:????,url:????}]]不能为空', trigger: 'blur' }
          ],
          content: [
            { required: true, message: '??不能为空', trigger: 'blur' }
          ],
