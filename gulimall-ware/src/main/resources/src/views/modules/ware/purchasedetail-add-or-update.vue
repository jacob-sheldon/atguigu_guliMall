<template>
  <el-dialog
    ...
    <el-form-item label="???id" prop="purchaseId">
      <el-input v-model="dataForm.purchaseId" placeholder="???id"></el-input>
    </el-form-item>
    ...
    <el-form-item label="??id" prop="wareId">
      <el-input v-model="dataForm.wareId" placeholder="??id"></el-input>
    </el-form-item>
    <el-form-item label="??[0??,1???,2????,3???,4????]" prop="status">
      <el-input v-model="dataForm.status" placeholder="??[0??,1???,2????,3???,4????]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          status: [
            { required: true, message: '??[0??,1???,2????,3???,4????]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
